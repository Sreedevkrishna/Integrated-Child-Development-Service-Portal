...
<form id="form1" name="form1" method="post" action="">
  <center><table width="368" border="10" class="content-table">
  <?php
	include("connect.php");
	session_start();
    $lid=$_SESSION['lid'];
  ...
  <thead>
    <tr>
      ...
      <th width="138">PARENT DETAILS</th>
    </tr>
    </thead>
     <?php
	$i=1;
    ...
    ?>
      ...
      <td><?php echo $row['parent_name']?><br/><?php echo $row['parent_phone']?><?php echo $row['parent_email']?><br/></td>
