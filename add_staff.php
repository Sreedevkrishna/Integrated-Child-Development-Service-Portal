...
<form id="form1" name="form1" method="post" action="">
  <center><p> <table width="200" border="0">
    ...
    <tr>
      ...
      <input type="number" name="textfield3" id="textfield3" /></td>
    ...
    <tr>
      ...
      <input type="date" name="textfield5" id="textfield5" /></td>
...
if(isset($_POST['button']))
{
	...
	$lid=mysql_insert_id();
	$qry=mysql_query("INSERT INTO `staff`(`name`,`gender`,`phone`,`email`,`dob`,`type`,`login_id`,`health_lid`)VALUES('$name','$gender','$phone','$email','$dob','$type','$lid','$hid')");
	if($qry>0)
	{
		?>
        <script>
