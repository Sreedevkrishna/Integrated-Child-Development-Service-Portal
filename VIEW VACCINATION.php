...
<form id="form1" name="form1" method="post" action="">
 <center> 
 <h3 class="sre">vaccination details</h3>
 <table width="454" border="10" align="center" class="content-table">
   <?php
	include("connect.php");
    ...
    <tr>
     ...
     <p>  <td><button class="delete"><a href="delete_vaccination.php?id=<?php echo $row['vaccination_id']?>">DELETE</a></button></td></p>
    </tr>
    <?php
	}?>
  </table></center>
